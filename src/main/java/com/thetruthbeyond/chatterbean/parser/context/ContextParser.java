...
public class ContextParser {
	...
	public Context parse(InputStream properties, InputStream predicates) throws IOException, SAXException {
		Context context = new Context();
		
		PropertiesHandler propertiesHandler = new PropertiesHandler(context);
		parser.parse(properties, propertiesHandler);
		
		PredicatesHandler predicatesHandler = new PredicatesHandler(context);
		parser.parse(predicates, predicatesHandler);
